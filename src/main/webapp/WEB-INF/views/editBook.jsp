...
<body class="wrapper">
    ...
    <main>
    <div>
        <form action="<%=request.getContextPath()%>/reinsertBook" method="post" enctype="multipart/form-data" id="data_upload_form">
            <h1>書籍の編集</h1>
            <div class="content_body add_book_content"> 
                ...
                <div class="content_right">
                    ...
                    <div>
                        ...
                        <c:if test="${empty bookDetailsInfo}">
                            <input type="text" name="publish_date" value="" placeholder="YYYYMMD">
                        </c:if>
                    </div>
                    <div>
